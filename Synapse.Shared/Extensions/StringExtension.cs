...
namespace Synapse.Shared.Extensions
{
    public static class StringExtension
    {
        ...
        public static DateTime HourMinutesAsDateTime(this string value)
        {
            ...
            return new DateTime(System.DateTime.Now.Year, System.DateTime.Now.Month, System.DateTime.Now.Day, splits[0].AsInteger(), splits[1].AsInteger(), 0);
        }
        ...
        public static string ExtractNumberAtEnd(this string value)
        {
            var result = value.RegexMatchExtractFirstValue(@"\d+$");
        ...
        {
            StringBuilder output = new System.Text.StringBuilder(str.Substring(0, 1));
        ...
        public static IEnumerable<string> SplitInParts(this string str, int partLength)
        {
            if (str.IsEmpty())
            {
                throw new ArgumentNullException("SplitInParts - str");
            }
            if (partLength <= 0)
            {
        ...
        public static string GetNumberLastString(this string str, int num = 4)
        {
